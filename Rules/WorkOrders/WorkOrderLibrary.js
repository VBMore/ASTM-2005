...
export class WorkOrderLibrary {
    ...
    */
    ...
    static getWorkOrdersListViewQueryOptions() {
        ...
        + '$expand=WODocuments,OrderMobileStatus_Nav,Operations,Operations/SubOperations,WOPriority,MarkedJob,UserTimeEntry_Nav&'
    ...
    static getHighPriorityWorkOrdersQueryOptions() {
        ...
        + '&$expand=WODocuments,OrderMobileStatus_Nav,Operations,Operations/SubOperations,WOPriority,MarkedJob,WOGeometries,WOGeometries/Geometry,HeaderLongText,UserTimeEntry_Nav&'
            ...
            case 'FunctionalLocationLstPkr':
                {
                    ...
                    result = `$filter=(PlanningPlant eq '' or PlanningPlant eq '${planningPlant}')&$orderby=FuncLocIdIntern`;
                    break;
                }
            case 'EquipmentLstPkr':
                {
