...
export default class {
     ...
     * @param {*} context 
     * @param {*} reuturnEmpty - Return an empty array
     * @param {*} clockOut - Add the most recent clock out row if it isn't already there
     */
    static reloadUserTimeEntries(context, returnEmpty=false, clockOut) {

        if (libThis.isCICOEnabled(context) && libCom.isDefined(context.binding)) {
