...
function setStockItem(context) {
    ...
    context.getPageProxy().evaluateTargetPath('#Control:MaterialLstPkr').setEditable(true);
    context.getPageProxy().evaluateTargetPath('#Control:MaterialUOMLstPkr').setVisible(true);
    context.getPageProxy().evaluateTargetPath('#Control:MaterialUOMLstPkr').setEditable(true);
    context.getPageProxy().evaluateTargetPath('#Control:StorageLocationLstPkr').setVisible(true);
    context.getPageProxy().evaluateTargetPath('#Control:StorageLocationLstPkr').setEditable(true);

    // Disable Text Picker Items
    context.getPageProxy().evaluateTargetPath('#Control:TextItemSim').setVisible(false);
    context.getPageProxy().evaluateTargetPath('#Control:TextItemSim').setEditable(false);
    context.getPageProxy().evaluateTargetPath('#Control:UOMSim').setVisible(false);
    context.getPageProxy().evaluateTargetPath('#Control:UOMSim').setEditable(false);
}
...
function setTextItem(context) {
    ...
    context.getPageProxy().evaluateTargetPath('#Control:MaterialLstPkr').setEditable(false);
    context.getPageProxy().evaluateTargetPath('#Control:MaterialUOMLstPkr').setVisible(false);
    context.getPageProxy().evaluateTargetPath('#Control:MaterialUOMLstPkr').setEditable(false);
    context.getPageProxy().evaluateTargetPath('#Control:StorageLocationLstPkr').setVisible(false);
    context.getPageProxy().evaluateTargetPath('#Control:StorageLocationLstPkr').setEditable(false);

    // Enable Text Picker items
    context.getPageProxy().evaluateTargetPath('#Control:TextItemSim').setVisible(true);
    context.getPageProxy().evaluateTargetPath('#Control:TextItemSim').setEditable(true);
    context.getPageProxy().evaluateTargetPath('#Control:UOMSim').setVisible(false);
    context.getPageProxy().evaluateTargetPath('#Control:UOMSim').setEditable(false);
}
