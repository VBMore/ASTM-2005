...
export default function CharacteristicValue(context, characteristic, withUOM=true) {
    ...
    switch (dataType) {
        ...
        case 'TIME': 
            switch (singleValue) {
                case 'X':
                    result = assembleDisplayValues(context,characteristic.ValueRel, timeDisplayValue(context, characteristic.CharValFrom), timeDisplayValue(context, characteristic.CharValTo), 'SingleValues', withUOM);
                    break;
                default:
