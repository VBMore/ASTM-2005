...
export default function EquipmentQueryOptions(context) {
    ...
    if (searchString) {
        ...
        qob.expand('ObjectStatus_Nav/SystemStatus_Nav,EquipDocuments,WorkOrderHeader,WorkCenter_Main_Nav').orderBy('EquipId').select('ObjectStatus_Nav/SystemStatus_Nav/StatusText,WorkOrderHeader/OrderId,EquipDesc,EquipId,PlanningPlant,MaintPlant,WorkCenter');
        let filters = [
