...
export class ChecklistLibrary {
   ...
   /**
    ...
    static allowWorkOrderComplete(context, equipment) {
        ...
        return context.count('/SAPAssetManager/Services/AssetManager.service',"MyEquipments('" + equipment + "')/ChecklistBusObject_Nav", "$expand=Form_Nav&$filter=Form_Nav/MobileStatus ne '" + completed + "'").then(count => {
